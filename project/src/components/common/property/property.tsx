        ...
        <div className='property__container container'>
          <div className='property__wrapper'>
            ...
            <div className='property__name-wrapper'>
              ...
              <button className={classNames('property__bookmark-button', 'button', {'property__bookmark-button': isFavorite})} type='button'>
            ...
            <div className='property__host'>
              ...
              <div className='property__host-user user'>
                <div
                  className={
                    classNames('property__avatar-wrapper user__avatar-wrapper', {
